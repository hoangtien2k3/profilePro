...
1. Create a file called .env in the root directory of your project (if not done already in
...
- When you are done with the configuration, we highly recommend to read through
